...
<div id="global">
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal create_user" action="<?=site_url('staff/edit')?>" method="post" enctype = "multipart/form-data">
                       ...
                       <div class="col-sm-12">
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name= "staff_title" value="<?php echo @$val->staff_title; ?>" class="form-control" placeholder="Enter Title" required>
                        </div>
                       </div>
                       ...
                       <div class="col-sm-12">
                        <div class="form-group">
                            <label>Content</label>
                            <textarea name="staff_content" required><?php echo @$val->staff_content; ?></textarea>
