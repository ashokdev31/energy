...
<div id="global">
            <div class="container-fluid">
                <div class="panel panel-default">
                    ...
                    <form class="form-horizontal create_user" action="<?=site_url('services/edit')?>" method="post" enctype = "multipart/form-data">
                       ...
                       <div class="col-sm-12">
                        <div class="form-group">
                            <label>Title</label>
                            <input type="text" name= "services_title" value="<?php echo @$val->services_title; ?>" class="form-control" placeholder="Enter Title" required>
                        </div>
                       </div>
                       ...
                       <div class="col-sm-12">
                        <div class="form-group">
                            <label>Content</label>
                            <textarea name="services_content" required><?php echo @$val->services_content; ?></textarea>
